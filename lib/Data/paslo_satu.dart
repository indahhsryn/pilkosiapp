...
class Kandidat1 extends StatefulWidget {
  const Kandidat1({Key? key}) : super(key: key);

  @override
  _Kandidat1State createState() => _Kandidat1State();
}

class _Kandidat1State extends State<Kandidat1> {
  @override
