...
class Kandidat4 extends StatefulWidget {
  const Kandidat4({Key? key}) : super(key: key);

  @override
  _Kandidat4State createState() => _Kandidat4State();
}

class _Kandidat4State extends State<Kandidat4> {
  @override
