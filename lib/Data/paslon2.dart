...
class Kandidat2 extends StatefulWidget {
  const Kandidat2({Key? key}) : super(key: key);

  @override
  _Kandidat2State createState() => _Kandidat2State();
}

class _Kandidat2State extends State<Kandidat2> {
  @override
